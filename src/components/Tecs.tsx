...
export default function Tecs(props: TecsProps) {
  return (
    <div className=" md:w-[20%] lg:w-[22%] w-auto sm:text-2xl text-[18px] mx-auto flex justify-center flex-nowrap py-2 px-0 sm:py-0 text-center bg-slate-400/0 dark:bg-[#20202000] dark:text-[#FFFFFF]">
