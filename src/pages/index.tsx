  ...
  return (
    <div className="bg-slate-400 dark:bg-[#202020] dark:text-[#FFFFFF] transition-colors duration-500 ease-in-out overflow-hidden">
      <Parallax ref={ref} pages={3} className="">
            ...
            <div className="flex container mx-auto flex-wrap md:flex-nowrap my-auto">
              ...
              <div className="text-center">
                ...
                <p className="text-xl mx-[6px] sm:mx-4">
                  ...
                  aprender mais e mais sobre as rotinas e tecnologias do front,
                  eu já fiz trabalhos de design, sei mexer no figma, já fiz
                  campanhas de anúncio e um alguns trabalhos com React.
                </p>
              </div>
            </div>
          </main>
        ...
        <ParallaxLayer offset={2.2} factor={0.8} speed={2}>
